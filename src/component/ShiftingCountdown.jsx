...
const COUNTDOWN_FROM = "10/30/2023";
...
const ShiftingCountdown = () => {
  ...
  return (
    <div className="hidden md:block lg:block">
      <div className=" w-full max-w-xl rounded-md mt-4 mx-auto flex items-center text-white bg-primary">
...
const CountdownItem = ({ num, text }) => {
  return (
    <div className=" font-poppins w-56 h-14 flex flex-col gap-1 items-center justify-center  border-slate-200">
      ...
      <span className="text-xs font-poppins text-slate-200">
        {text}
      </span>
    </div>
  );
