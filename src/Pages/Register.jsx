    ...
    >
      ...
      <div className="absoulte top-0 left-0 w-full h-screen -z-20">
        ...
        <div className=" flex items-center justify-center h-screen ">
          <div className="p-8 text-white bg-transparent md:border border-white rounded-lg shadow-lg w-96 ">
            ...
            <div className="flex items-center justify-center">
              <Link to={"/Login"}>
              <button onClick={handleSubmit} className="md:w-80 py-2 mt-6 text-white bg-primary border-slate-300 rounded-md hover:bg-slate-300 hover:text-primary font-bold hover:scale-[104%]">
                Register
              </button>
              </Link>
            </div>
           ...
           <div className="w-full flex justify-between items-center mt-8 text-xs">
              <div className="w-full flex py-2 items-center justify-center mt-6">
              <Link to={"/Login"}>
                <label className="cursor-pointer font-poppins">Already have an account ? <label className="cursor-pointer text-primary font-poppins font-bold">Login</label> </label>
              </Link>
