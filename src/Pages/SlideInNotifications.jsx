  ...
  return (
    <div className="bg-white min-h-[200px] flex items-center justify-center">
      <button
        ...
        className="text-sm text-white bg-primary hover:bg-red-700 active:scale-95 transition-all font-medium px-3 py-2 rounded"
      >
        See More
      </button>
      <div className="mt-20 flex flex-col gap-1 w-72 fixed top-2 right-2 z-50 pointer-events-none">
        <AnimatePresence>
          {notifications.map((n) => (
